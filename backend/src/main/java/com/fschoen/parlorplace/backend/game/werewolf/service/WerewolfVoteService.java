...
@Service
@Slf4j
public class WerewolfVoteService extends AbstractPlayerVoteService<WerewolfVote, WerewolfGame, WerewolfPlayer, WerewolfPlayerVoteCollection, WerewolfGameRepository, WerewolfVoteRepository> {

    @Autowired
    public WerewolfVoteService(CommunicationService communicationService, UserRepository userRepository, WerewolfGameRepository gameRepository, WerewolfVoteRepository voteRepository, @Qualifier("taskExecutor") TaskExecutor taskExecutor) {
