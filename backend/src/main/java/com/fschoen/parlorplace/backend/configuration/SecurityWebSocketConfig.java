...
public class SecurityWebSocketConfig extends AbstractSecurityWebSocketMessageBrokerConfigurer {
    ...
    protected boolean sameOriginDisabled() {
        // TODO Allow only on endpoint - I don't know how to, I tried (see WebSocketConfig#registerStompEndpoints(StompEndpointRegistry registry)) to allow only for my domain, but it seems that this does not work with authentication
        return true;
    }
